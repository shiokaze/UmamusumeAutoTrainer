...
TEAM_STADIUM_CONFIRM_CANCEL = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(200, 830), "返回", None)
...
TEAM_STADIUM_TO_TIME_SALE = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(500, 830), "前往限时特卖", None)
